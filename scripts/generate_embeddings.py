...
idx = int(0.8 * tokenized_texts_train.shape[0])

tokenized_texts_train = tokenized_texts_data[:idx]
tokenized_texts_test = tokenized_texts_test[:idx]
...
train_embeddings = text_embeddings(tokized_texts_train, word_pmis, word2text_count, N)
embeddings = text_embeddings(tokenized_texts, words_pmis, word2text_count, N)
test_embeddings = text_embeddings(tokized_texts_test, word_pmis, word2text_count, N)
...
with open(path + "large_test_embeddings2.p") as file:
    pickle.dump(
